...
INSERT INTO medewerkers VALUES ('8001', 'DE CUBE', 'J', 'STAGAIR',8001,'2001-01-01', 400.00, null, 20, 'M');
                                                                                  -- [TEST]
...
UPDATE schalen SET bovengrens=3000.00 WHERE snr=5;
INSERT INTO schalen VALUES (6, 3001.00, 4000, 500.00);
...
values ('D&P', 'Data & Persistency', 'ALG', 3);
insert into uitvoeringen (cursus, begindatum, docent, locatie)
values ('D&P', '2020-10-10', '7876', 'UTRECHT');
insert into inschrijvingen (cursist, cursus, begindatum, evaluatie)
values (7499, 'D&P', '2020-10-10', 5),
       (7698, 'D&P', '2020-10-10', 5),
       (7521, 'D&P', '2020-10-10', 5);
...
UPDATE medewerkers SET maandsal=maandsal*1.055 WHERE (functie<>'MANAGER' AND afd=30);
UPDATE medewerkers SET maandsal=maandsal*1.07 WHERE (functie='MANAGER' AND afd=30);
...
-- Hij is nog een cursist bij een andere tabel
...
insert into medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd, m_geslacht_chk)
values (8002, 'VRIJ', 'S', 'HOOFD', 8002, '2001-03-08', 4000.00, null, 90, 'M');
insert into afdelingen (anr, naam, locatie, hoofd)
values (nextval('afdelingsnummers'), 'FINANCTIEN', 'LEERDAN', 8002);
                                                                                     -- [TEST]
-- -------------------------[ HU TESTRAAMWERK ]--------------------------------
